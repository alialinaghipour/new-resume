...
function LoadCreateModal() {
    $.ajax({
        url: "/Admin/Work/LoadCreateModal",
        type: "get",
        beforeSend: function () {
            StartLoading();
        },
        success: function (res) {
            ...
            $('#WorkCreate').data('validator', null);
            $.validator.unobtrusive.parse("#WorkCreate");
...
function WorkCreate(res) {
    ...
    if (res.status === 'Success') {
        ...
        ShowMessage(res.errorMessage, 'پیغام خطا', 'error')
    }
}

function LoadUpdateModal(id) {
    $.ajax({
        url: "/Admin/Work/LoadUpdateModal",
        type: "get",
        data :{
            id: id
        },
        ...
        success: function (res) {
            ...
            $('#WorkUpdate').data('validator', null);
            $.validator.unobtrusive.parse("#WorkUpdate");
...
function LoadCreateFeedbackModal() {
    $.ajax({
        url: "/Admin/Feedback/LoadCreateFeedbackModal",
        type: "get",
        beforeSend: function () {
            StartLoading();
        },
        success: function (res) {
            ...
            $('#FeedbackCreate').data('validator', null);
            $.validator.unobtrusive.parse("#FeedbackCreate");
